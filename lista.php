...
include 'conexao.php';
	...
	$sql = mysql_query("SELECT * FROM tb_produtos WHERE gtin LIKE '{$_POST['busca_gtin']}%' OR nome LIKE '{$_POST['busca_gtin']}%'");
...
<body link=black alink='green' vlink='black' Onload="inicio()">
	<div class="container">
		...
		<b><h1><font color="#602d8f"> Digite o GTIN do medicamento: </font></h1>
